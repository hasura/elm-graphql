...
metaTitle: "Query to fetch todo | GraphQL Elm Apollo Tutorial"
...
We will be generating the above query using the utility functions generated by `elm-graphl` in our elm app. Lets verify it for now to make sure it works as expected.
